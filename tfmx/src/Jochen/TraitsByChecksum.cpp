...
void tfmxaudiodecoder::HippelDecoder::traitsByChecksum() {
    ...
    if (offsets.header != 0) {
        ...
        // Leaving Teramis
        // some others
        if (crc1 == 0xb6105cbf || crc1 == 0xb4f798e6 || crc1 == 0xed5cfac0 || crc1 == 0x6c55f30a) {
    ...
    if (traits.compressed) {
        ...
        // Chambers of Shaolin
        // Dragonflight (musf)
        if (crc2 == 0x5495cc19 || crc2 == 0x7866963a || crc2 == 0xc04a79a7 || crc2 == 0x2158d5fc || crc2 == 0x2518e0aa
            || crc2 == 0x3e8f7323) {
            pPortamentoFunc = &HippelDecoder::TFMX_portamento;
        }
        // Wings of Death level 1-7
        if (crc2 == 0x6084ae9f || crc2 == 0x8ec439c || crc2 == 0x664a0708 || crc2 == 0x5cbcc3e9 || crc2 == 0x58514e2
            || crc2 == 0x9beab3a4 || crc2 == 0xb6185651) {
