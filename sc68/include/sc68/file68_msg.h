...
FILE68_API FMT34
     ...
     */
    void
    msg68x(int cat, void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_critical(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_error(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_warning(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_notice(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_info(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_debug(void* cookie, const char* fmt, ...);
...
FILE68_API FMT23
     ...
     */
    void
    msg68x_trace(void* cookie, const char* fmt, ...);
