 ...
 */
typedef vfs68_t* (*rsc68_handler_t)(rsc68_t type, const char* name, int mode, rsc68_info_t* info);
 ...
 */
vfs68_t* rsc68_open(rsc68_t type, const char* name, int mode, rsc68_info_t* info);
