 ...
 */
registry68_key_t registry68_open(registry68_key_t hkey, const char* kname, int mode);
 ...
 * @retval -1 Error
 */
int registry68_puts(registry68_key_t hkey, const char* kname, const char* kdata);
